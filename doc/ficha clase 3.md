...
- **Nombre:** Entrenador 
- **Responsabilidad principal:** Capturar a los pokemones
- **Atributos necesarios:** Nombre, EXP
- **Métodos posibles:** Utilización de poke ball, utilizacion de items para el pokemon
- **Clase con la que necesita colaborar:** Inventario, pokemon
- **Regla o criterio de aceptación que la justifica:** Probabilidad de captura, fuera de rango o dentro de rango
- **Responsabilidad que no debería asumir:**  

 Clase Plantilla

*Nombre:** Inventario
- **Responsabilidad principal:** Items para el entrenador
- **Atributos necesarios:** Items, tipos de items
- **Métodos posibles:** 
...
1. ¿Existe una clase que concentre casi todas las acciones? ¿Cuál y qué responsabilidad debería trasladarse?
   ...
   **Respuesta:** La clase que concentra casi todas las acciones es el inventario

2. ¿Existe un método en una clase que no posee los datos necesarios para realizarlo?

   **Respuesta:** No, no existe un metodo en una clase que no 
